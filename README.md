...
Quotes will get you results that include exactly what you typed inside of in, in that exact order. Quotes can also be used to find results that may be within a desired time range. For example:
